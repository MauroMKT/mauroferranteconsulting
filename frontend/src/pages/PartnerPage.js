...
const partnersData = {
  ...
  "evolution-media": {
    ...
    fullName: "Evolution Media Group LLC",
    logo: "/images/logo-evolution-media.webp",
    logoBg: "#ffffff",
    heroImage: "https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&q=60&fit=crop",
    website: "https://evolutionmediagroups.com/",
    description: {
      en: "Evolution Media Group is a digital marketing agency specialising in qualified lead generation for real estate agents and agencies. Their proprietary system delivers 5-10 pre-qualified seller leads per week and 2-6 additional listings per month directly to partner agents. With a focus on hyper-targeted campaigns, they help real estate professionals acquire high-value property listings through advanced digital marketing strategies, profiled appointments, and a data-driven approach that eliminates wasted time on unqualified contacts.",
      it: "Evolution Media Group e un'agenzia di marketing digitale specializzata nella generazione di lead qualificati per agenti e agenzie immobiliari. Il loro sistema proprietario consegna 5-10 venditori qualificati a settimana e 2-6 incarichi aggiuntivi al mese direttamente agli agenti partner. Con un focus su campagne iper-mirate, aiutano i professionisti immobiliari ad acquisire incarichi di vendita di alto valore attraverso strategie avanzate di marketing digitale, appuntamenti profilati e un approccio data-driven che elimina le perdite di tempo con contatti non qualificati.",
      es: "Evolution Media Group es una agencia de marketing digital especializada en la generacion de leads cualificados para agentes y agencias inmobiliarias. Su sistema propietario entrega 5-10 vendedores cualificados por semana y 2-6 encargos adicionales al mes directamente a los agentes asociados. Ayudan a los profesionales inmobiliarios a adquirir propiedades de alto valor a traves de estrategias avanzadas de marketing digital.",
      fr: "Evolution Media Group est une agence de marketing digital specialisee dans la generation de leads qualifies pour les agents et agences immobilieres. Leur systeme proprietaire fournit 5 a 10 vendeurs qualifies par semaine et 2 a 6 mandats supplementaires par mois directement aux agents partenaires. Ils aident les professionnels de l'immobilier a acquerir des mandats de haute valeur.",
      de: "Evolution Media Group ist eine Agentur fur digitales Marketing, die sich auf die qualifizierte Lead-Generierung fur Immobilienmakler und -agenturen spezialisiert hat. Ihr proprietares System liefert 5-10 vorqualifizierte Verkaufer-Leads pro Woche und 2-6 zusatzliche Auftrage pro Monat direkt an Partnermakler.",
    },
    collaboration: {
      en: "Mauro Ferrante Consulting Studio collaborates with Evolution Media Group to amplify the digital acquisition strategies for real estate professionals across Italy and internationally. Together, we combine strategic consulting with cutting-edge lead generation technology to deliver measurable results: more qualified appointments, higher conversion rates, and a consistent pipeline of high-value property listings.",
      it: "Mauro Ferrante Consulting Studio collabora con Evolution Media Group per amplificare le strategie di acquisizione digitale per i professionisti immobiliari in Italia e a livello internazionale. Insieme, combiniamo consulenza strategica con tecnologia di lead generation all'avanguardia per offrire risultati misurabili: piu appuntamenti qualificati, tassi di conversione piu alti e una pipeline costante di incarichi immobiliari di alto valore.",
      es: "Mauro Ferrante Consulting Studio colabora con Evolution Media Group para amplificar las estrategias de adquisicion digital para profesionales inmobiliarios en Italia e internacionalmente.",
      fr: "Mauro Ferrante Consulting Studio collabore avec Evolution Media Group pour amplifier les strategies d'acquisition digitale des professionnels de l'immobilier en Italie et a l'international.",
      de: "Mauro Ferrante Consulting Studio arbeitet mit Evolution Media Group zusammen, um die digitalen Akquisitionsstrategien fur Immobilienprofis in Italien und international zu verstarken.",
    },
    services: {
      en: ["Qualified seller lead generation", "Hyper-targeted Meta & Google campaigns", "Pre-profiled appointment booking", "Real estate listing acquisition", "Territory-specific digital visibility", "Conversion rate optimisation", "Agent partner programs", "Data-driven marketing analytics"],
      it: ["Generazione lead venditori qualificati", "Campagne Meta & Google iper-mirate", "Prenotazione appuntamenti profilati", "Acquisizione incarichi di vendita", "Visibilita digitale sul territorio", "Ottimizzazione tasso di conversione", "Programmi per agenti partner", "Analytics di marketing data-driven"],
      es: ["Generacion de leads de vendedores cualificados", "Campanas Meta & Google hiper-segmentadas", "Reserva de citas perfiladas", "Adquisicion de encargos de venta", "Visibilidad digital territorial", "Optimizacion de conversion", "Programas para agentes asociados", "Analytics de marketing basado en datos"],
      fr: ["Generation de leads vendeurs qualifies", "Campagnes Meta & Google hyper-ciblees", "Prise de rendez-vous profiles", "Acquisition de mandats de vente", "Visibilite digitale territoriale", "Optimisation du taux de conversion", "Programmes pour agents partenaires", "Analytics marketing data-driven"],
      de: ["Qualifizierte Verkaufer-Lead-Generierung", "Hyper-zielgerichtete Meta & Google Kampagnen", "Vorqualifizierte Terminbuchung", "Listing-Akquise", "Territoriale digitale Sichtbarkeit", "Conversion-Rate-Optimierung", "Partner-Makler-Programme", "Datengesteuerte Marketing-Analytics"],
    },
    stats: [
      { icon: TrendingUp, value: "5-10", label: { en: "Qualified leads per week", it: "Lead qualificati a settimana", es: "Leads cualificados por semana", fr: "Leads qualifies par semaine", de: "Qualifizierte Leads pro Woche" } },
      { icon: Building2, value: "2-6", label: { en: "New listings per month", it: "Nuovi incarichi al mese", es: "Nuevos encargos al mes", fr: "Nouveaux mandats par mois", de: "Neue Auftrage pro Monat" } },
      { icon: Users, value: "50+", label: { en: "Partner agents", it: "Agenti partner", es: "Agentes asociados", fr: "Agents partenaires", de: "Partner-Makler" } },
      { icon: Globe, value: "IT", label: { en: "Primary market: Italy", it: "Mercato principale: Italia", es: "Mercado principal: Italia", fr: "Marche principal: Italie", de: "Hauptmarkt: Italien" } },
    ],
  },
  "kw-gchouse": {
    name: "KW GCHOUSE",
