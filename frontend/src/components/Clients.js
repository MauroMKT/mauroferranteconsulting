    ...
    <section id="clients" className="relative py-28 bg-[#0a0a0a] overflow-hidden" data-testid="clients-section">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {clients.map((client) => (
            <div key={client.name} className="group relative bg-[#0f0f0f] border border-white/5 rounded-xl overflow-hidden hover:border-[#c9a84c]/25 transition-all duration-500" data-testid={`client-card-${client.name.toLowerCase().replace(/\s/g, '-')}`}>
