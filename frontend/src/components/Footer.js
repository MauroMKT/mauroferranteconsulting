    ...
    <footer className="relative bg-[#060606] overflow-hidden" data-testid="footer">
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <button onClick={() => navigateTo("#contact")} className="mt-8 bg-[#c9a84c] hover:bg-[#d4b85d] text-[#0a0a0a] font-semibold text-sm px-8 py-4 rounded-lg transition-all duration-300" data-testid="footer-cta-btn">
            {t(locale, "hero_cta")}
          </button>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex items-center gap-3 mt-6">
                <a href="https://www.linkedin.com/in/mauro-ferrante/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#c9a84c]/20 transition-colors">
                  <LinkedInIcon className="w-3.5 h-3.5 text-white/40 hover:text-[#c9a84c]" />
                </a>
                <a href="https://www.instagram.com/mauroferranteconsulting/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#c9a84c]/20 transition-colors">
      ...
      <div className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <span className="text-white/10 text-[10px] tracking-wider">{t(locale, "footer_privacy")}</span>
        </div>
      </div>
    </footer>
  );
